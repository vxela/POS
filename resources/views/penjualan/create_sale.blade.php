                                        ...
                                        <table class="table table-condensed">
                                            ...
                                            <form class="trans_form" action="{{'/penjualan/potemp/'.$order->id}}" method="POST">
                                                        <tr>
                                                            ...
                                                            <button type="button" id="del_preorder_unit" class="btn btn-danger btn-xs pd-less-sm del_preorder_unit" data-id="{{$order->id}}" data-nama_produk="{{$order->getProduk()->product_name}}"><i class="lnr lnr-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                    </form>
                                                        @php
