			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="/admin/pegawai" class=""><i class="lnr lnr-file-add"></i> <span>Employee Setting</span></a></li>
						<li><a href="/admin/user" class=""><i class="lnr lnr-drop"></i> <span>User Seting</span></a></li>
						<li>
